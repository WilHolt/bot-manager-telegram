...
class TelegramBot {
    ...
    sendContact({ phoneNumber, firstName, chatId }) {
    ...
    sendPoll({ question, options, type, correctOptionID, chatId, disableNotification }) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const messageParams = qs_1.default.stringify({
                    chat_id: chatId || this.chatId,
    ...
    sendPhoto({ url, chatId }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = (yield (0, axios_1.default)(`${this.path}/sendPhoto?${messageParams}`));
            return response;
        });
    }
}
